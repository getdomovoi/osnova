...
(call target: (identifier) @kw (#any-of? @kw "def" "defp" "defmacro") (arguments (binary_operator left: (call target: (identifier) @name) @definition.head right: (call) @definition.head))) @definition.function
(call target: (identifier) @kw (#any-of? @kw "def" "defp" "defmacro") (arguments (identifier) @name)) @definition.function
