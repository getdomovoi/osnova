...
export type ReceiverOwner = SymbolBinding | { readonly kind: "return"; readonly of: Callee; readonly index?: number | undefined } | { readonly kind: "super"; readonly of: SymbolBinding };
