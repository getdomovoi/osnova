...
import type { EdgeBinding, EdgeKind, MemberKind, SourceSpan, SymbolBinding, SymbolKind } from "../types.js";
...
export class Extractor {
  ...
  addDef(name: string, kind: SymbolKind, node: Node, signatureNode?: Node, memberKind?: MemberKind, heritage?: readonly SymbolBinding[], fields?: readonly string[], returns?: SymbolBinding): void {
