      ...
      switch (node.type) {
        ...
        case "function_definition": {
          ...
          if (name !== null && IDENTIFIER_RE.test(name)) {
            out.addDef(name, isMethod ? "method" : "function", node, undefined, isMethod ? bindings.memberKind(node) : undefined, undefined, undefined, bindings.returns(node), undefined, undefined, bindings.unwrapped(node));
            out.push(name);
